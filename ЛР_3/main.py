...
def genetic_algorithm(city_list, pop_size, elite_size, mutation_rate, generations, num_best_routes=3,
    ...
    return best_route, best_route_list
...
def create_triangle_cities():
    ...
    for i in range(1, points_per_side):
        ...
        cities.append(City(len(cities), side_length - i * (side_length / points_per_side), i * (height / points_per_side)))
        
        cities.append(City(len(cities), (side_length / 2) - i * (side_length / (2 * points_per_side)), height - i * (height / points_per_side)))
...
if __name__ == "__main__":
    ...
    city_list,dist = create_circle_cities(city_count)
    print(dist)
    # print(city_list[0])
    plt.ion()
    best_route, best_route_list = genetic_algorithm(city_list=city_list, pop_size=100, elite_size=20,
